...
type byteSliceStringer []byte

func (v byteSliceStringer) String() string {
	if v == nil {
		return "nil"
	}
	return string(v)
...
func (v int64Stringer) String() string {
...
func (kv *KeyValue) String() string {
	return string(kv.key) + ":" + kv.ValueStringer().String()
}
...
// ValueStringer ...
func (kv *KeyValue) ValueStringer() fmt.Stringer {
	switch t := kv.value.(type) {
	case nil:
	case []byte:
		return byteSliceStringer(t)
	case *int64:
		return int64Stringer(*t)
	}
	return byteSliceStringer(nil)
}
